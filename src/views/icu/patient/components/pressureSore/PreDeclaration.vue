<template>
   ...
   <div>
            ...
            <tbody>
               ...
               <tr class="left">
                  ...
                  <td colspan="4">
                     ...
                     <el-input v-model="form.declarer" class="width"></el-input>
                  </td>
               </tr>
               <tr class="left">
                  <td colspan="3">
                  ...
                  <td colspan="4">
                     ...
                     <el-input v-model="form.diagnosis" class="width"></el-input>
                  </td>
               </tr>
               <tr class="left">
                  <td colspan="7">
               ...
               <tr class="left">
                  <td colspan="7">
                     ...
                     <el-checkbox-group v-model="declareReason">
                        <el-checkbox
               ...
               <tr class="left">
                  <td colspan="7">
                     <div style="display:flex;align-items:center;flex-wrap: wrap;">
                        <span>采取预防护理措施：</span>
                        <el-radio-group v-model="form.preventiveNursingMeasures">
                           <el-radio
                              :label="state.value"
               ...
               <tr class="left">
                  ...
                  <td colspan="4">
                     ...
                     <el-input v-model="form.soreRange" class="width"></el-input>
                  </td>
               </tr>
               <tr class="left">
                  <td colspan="5">
               ...
               <tr class="left">
                  <td colspan="7">
                     <div style="display:flex;align-items:center;flex-wrap: wrap;">
                        ...
                        <p>
                           <span>护士长签名：</span>
                           <el-input v-model="form.headNurse" style="width:150px"></el-input>
                        </p>
                     </div>
                  </td>
               </tr>
                  ...
                  <td colspan="7">
                     ...
                     <div style="display:flex;align-items:center;flex-wrap: wrap;">
                        ...
                        <p>
                           ...
                           <el-radio-group v-model="form.deptHeadNurseDeclare">
                     ...
                     <div style="display:flex;align-items:center;flex-wrap: wrap;">
                        ...
                        <p>
                           <span style="padding-left:10px">难免压疮申报条件：</span>
                           <el-radio-group v-model="form.woundManagementGroupDeclare">
               ...
               <tr class="left">
                  <td colspan="7">
                     ...
                     >
                        ...
                        <el-radio :label="1">未发生</el-radio>
                        <el-radio :label="2">发生</el-radio>
                        <span>（</span>
                        <el-radio-group
                           v-model="form.pressureSoreOutcome"
                           style="position:relative;top:-5px"
                        >
                           <el-radio :label="3">治愈</el-radio>
                           <el-radio :label="4">好转</el-radio>
                           <el-radio :label="5">未愈合</el-radio>
                        </el-radio-group>
                        <span>）</span>
                     </el-radio-group>
                  </td>
      ...
      <div class="operation_top">
         <el-button @click="sub()" class="el-button el-button--primary" v-if="subFlag">提交</el-button>
...
export default {
   ...
   methods: {
      // 数据回填
      dataBackFilling() {
         this.form.patientName = this.message.name;
         this.form.patientId = this.message.patientId;
         this.form.age = this.message.age;
         this.form.hospitalnumber = this.message.hospitalnumber;
         this.form.bedName = this.message.bedName;
         this.form.gender = this.message.gender;
         this.form.bedId = this.message.bedId;
         // console.log(this.processArr)
         if (this.processArr.indexOf("10") == -1) {
            this.reset();
         } else {
            query({ patientId: this.message.patientId }).then(response => {
               if (response.data.data.records.length > 0) {
                  this.form = response.data.data.records[0];
                  this.declareReason = this.form.declareReason.split(",");
                  this.form.pressureSoreOutcome = parseInt(
      ...
      getList() {
         ...
         // 请求字典表中的数据
         this.$parent.PreDeclarationDic.forEach(item => {
            if (item == "declare_reason") {
               var declare_reason = this.dicUrl(item);
               declare_reason.then(value => {
                  this.reason(value);
               });
            } else if (item == "preventive_nursing_measures") {
               var preventive_nursing_measures = this.dicUrl(item);
               preventive_nursing_measures.then(value => {
      ...
      preventive(value) {
         this.preventiveNursingMeasures = [];
         value.forEach(item => {
      ...
      sub() {
         ...
         switch ("") {
            ...
            default:
               this.$confirm(
                  "是否提交患者“" + this.message.name + "”难免压疮申报表?",
                  {

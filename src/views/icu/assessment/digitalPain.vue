   ...
   <basic-container>
      <div class="panel panel-default">
         <div class="panel-heading clearfix" v-if="!parentIf">
            <h3 class="panel-title">数字疼痛量评分</h3>
            <div class="perinfo">
         ...
         <!-- <div id="main" style="height: 300px;margin-bottom: 50px" class="main"></div> -->
            ...
            <table class="table table-bordered" id="basic-table" v-loading="loading">
               <thead>
                  <tr style="background-color:#f5f7fa">
                     ...
                     <th :colspan=" range.length  ">疼痛等级</th>
                     <!-- <th rowspan="2">测量值</th> -->
                     <!-- <th rowspan="2">得分</th> -->
                  </tr>
                  ...
                  if (
                     ...
                     for (let k in this.questionArr[i].assessProjects[j]
                        ...
                        if (
                           ...
                           this.count = this.questionArr[i].assessProjects[
                              j
         ...
         for (var i in items.projectConditions) {
            if (items.projectConditions[i].id == id) {
               if (items.projectConditions[i].selected == true) {
                  this.count = null;
                  this.questionArr.fliterNum = false;
                  items.number = null;
                  ...
                  this.questionArr.fliterNum = true;
                  items.number = score;
                  this.count = score;
               }
            } else {
            ...
            .then(() => {
               ...
               for (let i in this.questionArr) {
                  for (let j in this.questionArr[i].assessProjects) {
                     if (
                        this.questionArr.fliterNum == false ||
                        this.questionArr.fliterNum == undefined
                     ) {
                        this.$message({
                           type: "warning",
                           showClose: true,

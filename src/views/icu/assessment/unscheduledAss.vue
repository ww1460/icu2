<template>
  ...
  <basic-container>
    <div class="panel panel-default">
      <div class="panel-heading clearfix" style="margin-bottom:1%" v-if="!parentIf">
        <h3 class="panel-title">非计划性拔管风险评分</h3>
        <div class="perinfo">
      ...
      <!-- <div v-if="false" id="main" style="height: 300px;margin-bottom: 50px" class="main"></div> -->
      <div class="assTable">
    ...
    messages: {
      handler(newValue, oldValue) {
        ...
        for (let i in this.questionArr) {
          if (this.questionArr[0].assessProjects[0].pitchOnId == null) {
            // 第一次评估
            // console.log(123);
            for (let j in this.questionArr[i].assessProjects) {
              ...
              // console.log(this.questionArr[i].assessProjects)
            }
          } else {
            //  有过评估记录后  将上次评估的结果渲染
            for (let j in this.questionArr[i].assessProjects) {
              ...
              // if (this.questionArr[i].assessProjects[j].number === null) {
              // } else {

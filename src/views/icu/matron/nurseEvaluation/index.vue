...
<script>
import { addObj, delObj, fetchList, putObj ,UpdateObj} from '@/api/icu/matron/nurseEvaluation/nurseEvaluation'
import { tableOption } from '@/const/crud/icu/matron/nurseEvaluation/nurseEvaluation'
import { mapGetters } from 'vuex'

export default {
  name: 'nurseEvaluation',
  data() {
    return {
      searchForm: {},
      tableData: [],
  ...
  methods: {
    ...
    handleDel: function(row, index) {
      var _this = this
      this.$confirm('是否确认删除' + row.indicator, '提示', {
